This is the first in a series of articles that looks specifically at how science is defined in different mediums; whether that's websites, videos, books and media, etc.
...
The introduction is really great at not immediately defining science by reifying it, but giving specific instances of what we might think when we engage with the word *science.* And they're correctly identifying that our individual thoughts about science represent a small slice of science, and again, stipulating that none provides a full and comprehensive picture of science. This is honest, and it's doing a good job at connecting a general audience by validating what they initially think, and pulling them further in to learn more.

One, funnier than critical point I noticed was when they cite: "A naturalist in a forest." *Naturalist* can be polysemous, but I'm giving benefit of doubt, and choosing to believe they mean it in the non-philosophical definition. If, however, we decide to take them in the philosophical space: it is amusing to think that they meany to suggest a scientist is a ontologically committed naturalistic realist standing in the forest, with some sentiment of thought being: "Wow, how aesthetically appealing to think that, there is nothing more than what is here." 
...
The issue with discussing science as epistemic is the type of language that gets ported in: "science says," "science proves," "the science is there." These types of claims smuggle in science as an epistemic body, and many might think: well, isn't it?
...
This smuggles back in the reification problem (i.e., "science is also a process of discovery", but I won't rehash that. However, bringing up discovery imports the static image of scientific knowledge, which is the thought that, there is a set of true propositions waiting to be discovered. In reality, knowledge is constructed from epistemic communities with standards, goals, values, and histories rather than recovered from a mind-independent fact-space. This was inheritted and formalized by the logical positivst era that grounded the western/anglophone *"objective"* view as the center of science.

The sentiment is something like: science is an epistemic practice that happens to have human practioners. When in reality, each field of science is an epistemic community in constant contention about the standards and practices of their field. If, scientific knowledge exists in some "view from nowhere," static space, this would hold but that's a metaphysical commitment that sits outside of the scope any scientific inquiry, and yet, informs what scientific knowledge is for.

Often, mind-independence is not decoupled, and smuggled in every time *"objective"* is used in science talk. Hence, I avoid the use of objective, which isn't recovered by subjective, because it smuggles in the often disdained relativism critique. Relativism in science is often misunderstood, and worth visiting in an article on its own.

Back to the content, the view is likely what the authors of this page are accidently pointing at (i.e., biased toward the anglophone perspective) when they assert that science is actively linking isolated facts into a coherent web of knowledge disconnected from epistemic communities and how they generate, validate, and talk about science.
